...
:warning:(1): Wifi API changes in Android SDK 26 and 29, restricts certain behaviour:
  ...
  * b. This has been deprecated and will always fail for >= 26 Android SDK. There is a way to make "get" methods work for >= 29 Android SDK, but is currently not developed, request these feature if you need at [[#134](https://github.com/alternadom/WiFiFlutter/issues/134)].
